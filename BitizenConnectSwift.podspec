Pod::Spec.new do |spec|
  ...
  it in your wallet, or in your dapp - whatever you are working on.
                   DESC
  spec.homepage     = "https://github.com/BitizenConnect/BitizenConnectSwift"
  spec.license      = { :type => "MIT", :file => "LICENSE" }
  spec.author             = { "Bitizen" => "dev@bitizen.org" }
  spec.cocoapods_version = '>= 1.4.0'
  spec.platform     = :ios, "13.0"
  spec.swift_version = "5.0"
  spec.source       = { :git => "https://github.com/BitizenConnect/BitizenConnectSwift.git", :tag => "#{spec.version}" }
